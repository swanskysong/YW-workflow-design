...
public class Column {
    ...
    public static Field ORIGINAL_LINE       = field("original_line");
    ...
    public static class CODE_BLOCK {
        ...
        public static Field BEGIN_LINE          = field("code_block.begin_line");
        public static Field END_LINE            = field("code_block.end_line");
    ...
    public static class SIGNATURE {
        ...
        public static Field IN_CODE_BLOCK       = field("signature.in_code_block");
    }

    public static class CODE_SNIPPET {
        public static Field ID                  = field("code_snippet.id");
        public static Field LINE_TEXT           = field("code_snippet.line_text");
        public static Field ORIGINAL_LINE       = field("code_snippet.original_line");
        public static Field NAME                = field("code_snippet.name");
    }
}
